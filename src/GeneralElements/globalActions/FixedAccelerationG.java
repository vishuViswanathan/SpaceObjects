 ...
 */
public class FixedAccelerationG extends GlobalAction {
    ...
    public FixedAccelerationG() {
        super(Type.FIXEDACCELERATION);
    }

    public FixedAccelerationG(Vector3d direction, double fixedAcc) {
        super(Type.FIXEDACCELERATION);
    ...
    public FixedAccelerationG(String xmlStr) throws Exception {
        super(Type.FIXEDACCELERATION);
        setValues(xmlStr);
    }
